//
//  CustomCornerDraggableView.swift
...
public struct CustomCornerDraggableView<Content: View>: View {
    ...
    private var padding: UIEdgeInsets = .init(top: 14, left: 14, bottom: 14, right: 14)
    ...
    private func checkCallPlacement(for location: CGPoint, in rect: CGRect) -> CallViewPlacement {
        ...
        for placement in availablePlacements {
            ...
            } else if let currentMinDistance = minDistance, distance < currentMinDistance {
                minDistance = distance
                closestPlacement = placement
            }
        }
